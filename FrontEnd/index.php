                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#eng">Engineering
                                                            Civil
                                                            Mech.Materials. Metallurgy</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#earth">Earth
                                                            Sciences</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#teaching">Teaching
                                                            Aids</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#nano">Nanotechnology</a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) { ?>
                                                    <div class="column" style=" margin-bottom: 2%;">
                                                        <div class="card1">
                                                            ...
                                                            <h1 style="color:black"><?= strtoupper($row['p_name']) ?>
                                                            </h1>
                                                ...
                                                <div class="section-intro">
                                                    <div class="row">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#f-j">F -
                                                                    J</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#k-o">K - O
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#p-t">P - T
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#u-z">U -
                                                                    z</a>
                                                            </li>
                                                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="tab-content">
                                                ...
                                                <div id="a-e" class="tab-pane active">
                                                ...
                                                <div id="k-o" class="tab-pane fade"><br>
                                                    <div class="list-type1">
                                                ...
                                                <div id="p-t" class="tab-pane fade"><br>
                                                    <div class="list-type1">
                                                ...
                                                <div id="u-z" class="tab-pane fade"><br>
                                                    <div class="list-type1">
